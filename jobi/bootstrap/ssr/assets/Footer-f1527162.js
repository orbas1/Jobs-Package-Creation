...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="col-lg-2 col-md-3 col-sm-4 mb-20"><h5 class="footer-title">${ssrInterpolate(((_d = unref(footerCenter)) == null ? void 0 : _d.name) ? unref(footerCenter).name : _ctx.trans("Company"))}</h5>`);
